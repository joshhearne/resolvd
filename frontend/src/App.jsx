...
function AppRoutes() {
  ...
  return (
    <Routes>
      ...
      <Route path="/mfa-challenge" element={pendingMfa ? <MfaChallenge /> : <Navigate to="/login" replace />} />
      ...
      <Route path="/" element={<ProtectedRoute><Layout /></ProtectedRoute>}>
        ...
        <Route path="account/mfa" element={<Navigate to="/account/settings/mfa" replace />} />
