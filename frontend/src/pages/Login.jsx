...
export default function Login() {
  ...
  const cardClass =
    "bg-surface border border-border rounded-xl shadow-xl shadow-black/5 dark:shadow-black/40 p-8 max-w-sm w-full mx-4";
        ...
        <div className={cardClass}>
          ...
          <form onSubmit={handleBootstrapSubmit} className="space-y-3">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="btn-primary-hero w-full py-2.5"
            >
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center">
      <div className={cardClass}>
        ...
        {methods.bootstrap && (
          <div className="mb-4 p-3 bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-900/50 rounded text-xs text-amber-900 dark:text-amber-200">
            <strong>First-time setup:</strong> the first user to sign in (any
            method) becomes Admin.
          </div>
        )}
        ...
        {anySso && methods.local && (
          <div className="my-4 flex items-center gap-3 text-xs text-fg-dim">
...
function PoweredBy() {
  return (
    <div className="mt-6 flex items-center gap-2 text-xs text-fg-dim">
