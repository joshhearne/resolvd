      ...
      {isReopened && (
        ...
        >
          ...
          <span style={{ fontSize: "12px", color: "#7f1d1d", lineHeight: 1.4 }}>
            {ticket.review_note ||
              "This ticket was reopened for additional review."}
          </span>
        </div>
      )}
      ...
      <div style={{ padding: "10px 14px 6px" }}>
        ...
        >
          ...
          {ticket.submitter_name && (
            <span>Submitted by: {ticket.submitter_name}</span>
          )}
          {ticket.assignee_name && (
            <span>Assigned: {ticket.assignee_name}</span>
          )}
...
export default function PrintExport() {
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      root.style.colorScheme = hadDark ? "dark" : "light";
    };
  }, []);
  ...
  const active = tickets.filter(
    (t) => !t.blocker_type && t.internal_status !== "Closed",
  );
      ...
      >
        ...
        >
          <div>
            ...
            <div
              style={{ fontSize: "20px", fontWeight: 700, color: primaryColor }}
            >
              {siteName}
            </div>
